  ...
  module Bot
    ...
    class Behaviour
      ...
      def promote_dawn
        ...
        fortunes = [
          "Hey, check http://codesake.com. It will soon open to beta testers #dawnscanner #appsec services for #sinatra #codesake-bot", 
          "Hey, check http://codesake.com. It will soon open to beta testers #dawnscanner #appsec services for #rails #codesake-bot", 
          "Hey, check http://codesake.com. It will soon open to beta testers #dawnscanner #appsec services for #padrino #codesake-bot", 
          "Did you know that #dawnscanner can make code reviews for web applications written in #rails, #sinatra and #padrino too? #codesake-bot",
          "Did you know that #dawnscanner has more than 56 #cve #security checks? Run dawn -k and discover all of them #codesake-bot",
          "Do you care about your web application security? Follow both @codesake and @armoredcode #codesake-bot", 
          "If you care about your web application security you should really install #dawnscanner. Run gem install codesake-dawn now #codesake-bot",
        ]
